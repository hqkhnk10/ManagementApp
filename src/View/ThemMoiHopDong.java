 ...
 * @author DHC
 */
public class ThemMoiHopDong extends javax.swing.JDialog {

    /**
     * Creates new form ThemMoiHopDong
     */
    public ThemMoiHopDong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    }
     private void ThemHopDong(HopDong hd){
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Ngày kết thúc (yyyy-mm-dd):");
        ...
        jLabel8.setText("Ngày bắt đầu (yyyy-mm-dd):");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ThemMoiHopDong.class.getName()).log(Level.SEVERE, null, ex);
        }
        Date endDate = null;
        try {
        ...
        hd.setmaNV(Integer.parseInt(txtMaNV.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemMoiHopDong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemMoiHopDong dialog = new ThemMoiHopDong(new javax.swing.JFrame(), true);
